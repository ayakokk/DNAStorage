...
int main(int argc, char *argv[]){
  int beta=5, B=8, nu=2;         // fixed param
  ...
  unsigned int B0[] = { 5, 6, 9,10,12,17,18,20};
  unsigned int B1[] = {26,25,22,21,19,14,13,11};
  unsigned char *X0 = new unsigned char [beta];  // binary: B0 
  unsigned char *X1 = new unsigned char [beta];  // binary: B1
  unsigned char *Y  = new unsigned char [beta];  // binary: 0-31
