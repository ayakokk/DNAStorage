...
# メインの結果ファイル
OUTPUT_FILE="result/ex01a_normalized_ixy_table.txt"
CSV_FILE="result/ex01a_normalized_ixy_table.csv"
...
for condition in "${conditions[@]}"; do
    ...
    # ex01a_004_*.log から ex01a_009_*.log までのファイルを処理
    for i in 004 005 006 007 008 009; do
        LOGFILE="${OUTPUT_DIR}/ex01a_${i}_${condition}.log"
...
LATEX_FILE="result/ex01a_normalized_ixy_table.tex"
